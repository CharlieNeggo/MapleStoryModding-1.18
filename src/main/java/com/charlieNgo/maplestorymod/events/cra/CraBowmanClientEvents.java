...
public class CraBowmanClientEvents {

    @SubscribeEvent
    public static void onDamageEntityCrabow(AttackEntityEvent event) {
        if (event.getEntityLiving().getMainHandItem().getItem() == MapleCRASetItems.CRA_BOW.get()) {
