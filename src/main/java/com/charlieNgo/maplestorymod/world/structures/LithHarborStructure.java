...
public class LithHarborStructure extends StructureFeature<JigsawConfiguration> {

    public LithHarborStructure() {
    ...
    private static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        var newConfig = new JigsawConfiguration(
                () -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                        .get(new ResourceLocation(MapleStoryMod.MODID, "lith_harbor/start_pool")),
        ...
        if (generator.isPresent()) {
            ...
            MapleStoryMod.LOGGER.log(Level.INFO, "Lith Harbor at " + blockpos);
        }
