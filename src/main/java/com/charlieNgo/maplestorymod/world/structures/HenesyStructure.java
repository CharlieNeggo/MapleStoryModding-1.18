...
public class HenesyStructure extends StructureFeature<JigsawConfiguration> {

    public HenesyStructure() {
    ...
    private static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        var newConfig = new JigsawConfiguration(
                ...
                10 // In our case our structure is 1 chunk only but by using 5 here it can be replaced with something larger in datapacks
        );
