...
public class MapleInventoryMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public MapleInventoryMenu(Inventory p_39706_, boolean p_39707_, Player p_39708_) {
        ...
        for(int k = 0; k < 4; ++k) {
            ...
            this.addSlot(new Slot(p_39706_, 39 - k, 8, 8 + k * 18) {
                ...
                public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
                    return Pair.of(MapleInventoryMenu.BLOCK_ATLAS, MapleInventoryMenu.TEXTURE_EMPTY_SLOTS[equipmentslot.getIndex()]);
                }
            });
        }
