...
public class WoodenMask extends MapleMonster {
    private int life;

    public WoodenMask(EntityType<? extends WoodenMask> p_32591_, Level p_32592_) {
    ...
    public static boolean canSpawnWoodenMask(EntityType<WoodenMask> entity, LevelAccessor levelAccess,
