...
public class OctopusModel<Type extends Octopus> extends EntityModel<Type> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(76, 29).addBox(-3.0F, -32.0F, -6.0F, 1.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(12, 83).addBox(-2.0F, -33.0F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition bodyone = body.addOrReplaceChild("bodyone", CubeListBuilder.create().texOffs(74, 0).addBox(-7.0F, -22.0F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 6.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

        PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 11).addBox(-1.0F, -13.0F, 9.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(36, 44).addBox(-4.0F, -22.0F, 8.0F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -8.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

        PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(38, 35).addBox(-8.0F, -14.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-5.0F, -24.0F, -7.0F, 14.0F, 14.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -7.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

        PartDefinition leg = partdefinition.addOrReplaceChild("leg", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition cube_r4 = leg.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(80, 29).addBox(-1.0F, -21.0F, -5.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(60, 72).addBox(1.0F, -13.0F, 3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 6.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

        PartDefinition cube_r5 = leg.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(8, 0).addBox(1.0F, -4.0F, 2.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(28, 76).addBox(2.0F, -12.0F, 3.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -3.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
