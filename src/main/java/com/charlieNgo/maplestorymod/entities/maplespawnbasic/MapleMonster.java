package com.charlieNgo.maplestorymod.entities.maplespawnbasic;
...
public abstract class MapleMonster extends PathfinderMob implements Enemy {
    protected MapleMonster(EntityType<? extends MapleMonster> p_33002_, Level p_33003_) {
    ...
    public static boolean checkMonsterSpawnRules(EntityType<? extends MapleMonster> p_33018_, ServerLevelAccessor p_33019_, MobSpawnType p_33020_, BlockPos p_33021_, Random p_33022_) {
    ...
    public static boolean checkAnyLightMonsterSpawnRules(EntityType<? extends MapleMonster> p_33024_, LevelAccessor p_33025_, MobSpawnType p_33026_, BlockPos p_33027_, Random p_33028_) {
