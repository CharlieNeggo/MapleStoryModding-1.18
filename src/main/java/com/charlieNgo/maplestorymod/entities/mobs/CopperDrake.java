...
public class CopperDrake extends MapleMonster{
    private int life;

    public CopperDrake(EntityType<? extends CopperDrake> p_32591_, Level p_32592_) {
    ...
    public static boolean canSpawnCopperDrake(EntityType<CopperDrake> entity, LevelAccessor levelAccess,
