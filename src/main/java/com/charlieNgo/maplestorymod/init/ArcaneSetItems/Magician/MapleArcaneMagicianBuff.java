...
public class MapleArcaneMagicianBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneMagicianMaterial.ARCANE, MobEffects.DAMAGE_BOOST).build();

    public MapleArcaneMagicianBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
