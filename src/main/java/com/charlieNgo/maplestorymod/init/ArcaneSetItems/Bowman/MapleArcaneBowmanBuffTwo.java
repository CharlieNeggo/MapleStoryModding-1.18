package com.charlieNgo.maplestorymod.init.ArcaneSetItems.Bowman;
...
public class MapleArcaneBowmanBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneBowmanMaterial.ARCANE, MobEffects.NIGHT_VISION).build();

    public MapleArcaneBowmanBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
