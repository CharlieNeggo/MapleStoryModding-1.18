...
public class MapleArcaneMagicianBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneMagicianMaterial.ARCANE, MobEffects.LUCK).build();

    public MapleArcaneMagicianBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
