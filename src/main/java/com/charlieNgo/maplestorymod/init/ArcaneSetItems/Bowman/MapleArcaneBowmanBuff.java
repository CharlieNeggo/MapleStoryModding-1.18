...
public class MapleArcaneBowmanBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneBowmanMaterial.ARCANE, MobEffects.MOVEMENT_SPEED).build();

    public MapleArcaneBowmanBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
