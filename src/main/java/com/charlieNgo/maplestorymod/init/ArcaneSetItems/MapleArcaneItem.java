...
import com.charlieNgo.maplestorymod.init.AbsolabSetItems.MapleAbsolabMaterialInit;
...
public class MapleArcaneItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneMaterialInit.ARCANE, MobEffects.DAMAGE_BOOST).build();

    public MapleArcaneItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
