package com.charlieNgo.maplestorymod.init.AbsolabSetItems.Magician;
...
public class AbsolabMagicianBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabMagicianMaterial.ABSOLAB, MobEffects.DAMAGE_BOOST).build());

    public AbsolabMagicianBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
