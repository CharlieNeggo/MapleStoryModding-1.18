...
public class AbsolabMagicianBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabMagicianMaterial.ABSOLAB, MobEffects.LUCK).build());

    public AbsolabMagicianBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
