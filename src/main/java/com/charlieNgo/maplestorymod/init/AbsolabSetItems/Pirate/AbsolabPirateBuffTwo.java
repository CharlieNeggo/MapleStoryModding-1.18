...
public class AbsolabPirateBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabPirateMaterial.ABSOLAB, MobEffects.DAMAGE_BOOST).build());

    public AbsolabPirateBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
