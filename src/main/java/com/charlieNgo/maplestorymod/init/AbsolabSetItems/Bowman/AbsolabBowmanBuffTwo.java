package com.charlieNgo.maplestorymod.init.AbsolabSetItems.Bowman;
...
public class AbsolabBowmanBuffTwo extends ArmorItem {
    ...
    public AbsolabBowmanBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
