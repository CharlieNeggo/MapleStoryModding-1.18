...
public class MapleModItems {
    ...
    public static final RegistryObject<ArmorItem> RED_DUKE = ITEMS.register("red_duke", () ->
            new MapleUtgardWarriorBuff(MapleSilverMaterial.SILVER, EquipmentSlot.HEAD, new Item.Properties().tab(MapleStoryMod.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> YELLOW_JANGOON_ARMOR = ITEMS.register("yellow_jangoon_armor", () ->
            new ArmorItem(MapleSilverMaterial.SILVER, EquipmentSlot.CHEST, new Item.Properties().tab(MapleStoryMod.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> BROWN_JANGOON_PANTS = ITEMS.register("brown_jangoon_pants", () ->
            new ArmorItem(MapleSilverMaterial.SILVER, EquipmentSlot.LEGS, new Item.Properties().tab(MapleStoryMod.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> MAROON_JANGOON_SHOES = ITEMS.register("maroon_jangoon_shoes", () ->
            new MapleUtgardWarriorBuffTwo(MapleSilverMaterial.SILVER, EquipmentSlot.FEET, new Item.Properties().tab(MapleStoryMod.MAPLESTORY_TAB)));
