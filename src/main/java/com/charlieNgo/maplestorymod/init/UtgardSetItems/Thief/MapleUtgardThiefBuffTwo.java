package com.charlieNgo.maplestorymod.init.UtgardSetItems.Thief;
...
public class MapleUtgardThiefBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardThiefMaterial.UTGARD, MobEffects.DAMAGE_BOOST).build();

    public MapleUtgardThiefBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
