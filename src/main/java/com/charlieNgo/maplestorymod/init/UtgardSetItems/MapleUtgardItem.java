...
import com.charlieNgo.maplestorymod.init.CraSetItems.MapleCraMaterialInit;
...
public class MapleUtgardItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraMaterialInit.CRA, MobEffects.DAMAGE_BOOST).build();

    public MapleUtgardItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
