...
public class MapleUtgardSetItems {
    ...
    public static final RegistryObject<AxeItem> UTGARD_POLEARM = ITEMS.register("utgard_polearm", () ->
            new AxeItem(MapleUtgardWeaponInit.UTGARD, 20, -3.0F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<SwordItem> UTGARD_TWOHANDED_SWORD = ITEMS.register("utgard_twohanded_sword", () ->
            new SwordItem(MapleUtgardWeaponInit.UTGARD, 15, -2.0F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<SwordItem> UTGARD_KATANA = ITEMS.register("utgard_katana", () ->
            new SwordItem(MapleUtgardWeaponInit.UTGARD, 16, -1.8F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));

    //Bowman class
//    public static final RegistryObject<BowItem> UTGARD_BOW = ITEMS.register("utgard_bow", () ->
//            new BowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).maxStackSize(1)));
...
//            new BowItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).maxStackSize(1)));
    ...
    public static final RegistryObject<SwordItem> UTGARD_STAFF = ITEMS.register("utgard_staff", () ->
            new SwordItem(MapleUtgardWeaponInit.UTGARD, 2, -2F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<SwordItem> UTGARD_DAGGER = ITEMS.register("utgard_dagger", () ->
            new SwordItem(MapleUtgardWeaponInit.UTGARD, 14, 0.5F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<SwordItem> UTGARD_KATARA = ITEMS.register("utgard_katara", () ->
            new SwordItem(MapleUtgardWeaponInit.UTGARD, 9, 0.5F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));

    //Armor for Utgard Set
    //Utgard Set for Thiefs
    public static final RegistryObject<ArmorItem> UTGARD_CHASER_HAT = ITEMS.register("utgard_chaser_hat", () ->
            new ArmorItem(MapleUtgardMaterialInit.UTGARD, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> UTGARD_CHASER_CHEST = ITEMS.register("utgard_chaser_chest", () ->
            new ArmorItem(MapleUtgardMaterialInit.UTGARD, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> UTGARD_BATTLE_LEGGINGS = ITEMS.register("utgard_battle_leggings", () ->
            new ArmorItem(MapleUtgardMaterialInit.UTGARD, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> UTGARD_BATTLE_BOOTS = ITEMS.register("utgard_battle_boots", () ->
            new ArmorItem(MapleUtgardMaterialInit.UTGARD, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
}
