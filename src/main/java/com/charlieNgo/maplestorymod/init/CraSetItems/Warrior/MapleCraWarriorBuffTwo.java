package com.charlieNgo.maplestorymod.init.CraSetItems.Warrior;
...
public class MapleCraWarriorBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraWarriorMaterial.CRA, MobEffects.DAMAGE_RESISTANCE).build();

    public MapleCraWarriorBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
