...
public class MapleCraMagicianBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraMagicianMaterial.CRA, MobEffects.LUCK).build();

    public MapleCraMagicianBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
