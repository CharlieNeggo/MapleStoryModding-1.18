...
public class MapleCraWarriorBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraWarriorMaterial.CRA, MobEffects.DAMAGE_BOOST).build();

    public MapleCraWarriorBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
