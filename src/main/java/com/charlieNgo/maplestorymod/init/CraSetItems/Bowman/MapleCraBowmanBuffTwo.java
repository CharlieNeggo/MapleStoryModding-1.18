...
public class MapleCraBowmanBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraBowmanMaterial.CRA, MobEffects.MOVEMENT_SPEED).build();

    public MapleCraBowmanBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
