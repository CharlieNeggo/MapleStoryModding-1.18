package com.charlieNgo.maplestorymod.init.CraSetItems.Magician;
...
public class MapleCraMagicianBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraMagicianMaterial.CRA, MobEffects.DAMAGE_BOOST).build();

    public MapleCraMagicianBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
