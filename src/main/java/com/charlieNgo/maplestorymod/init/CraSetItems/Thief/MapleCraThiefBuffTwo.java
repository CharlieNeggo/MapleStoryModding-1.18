...
public class MapleCraThiefBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraThiefMaterial.CRA, MobEffects.MOVEMENT_SPEED).build();

    public MapleCraThiefBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
