...
public class AbsolabThiefBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabThiefMaterial.ABSOLAB, MobEffects.MOVEMENT_SPEED).build());

    public AbsolabThiefBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
