...
public class MapleArcanePirateBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcanePirateMaterial.ARCANE, MobEffects.JUMP).build();

    public MapleArcanePirateBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
