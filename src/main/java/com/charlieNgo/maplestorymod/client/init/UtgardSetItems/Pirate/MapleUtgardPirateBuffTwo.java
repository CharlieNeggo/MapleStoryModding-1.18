...
public class MapleUtgardPirateBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardPirateMaterial.UTGARD, MobEffects.JUMP).build();

    public MapleUtgardPirateBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
