...
public class MapleUtgardMagicianBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardMagicianMaterial.UTGARD, MobEffects.DAMAGE_BOOST).build();

    public MapleUtgardMagicianBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
