package com.charlieNgo.maplestorymod.client.init.CraSetItems.Pirate;
...
public class MapleCraPirateBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraPirateMaterial.CRA, MobEffects.DAMAGE_BOOST).build();

    public MapleCraPirateBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
