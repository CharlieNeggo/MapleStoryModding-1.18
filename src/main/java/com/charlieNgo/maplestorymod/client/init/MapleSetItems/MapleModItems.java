...
public class MapleModItems {
    ...
    public static final RegistryObject<Item> SILVER = ITEMS.register("silver_ore", ()->
            new Item(new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB).stacksTo(64)));
    public static final RegistryObject<Item> BRONZE = ITEMS.register("bronze_ore", ()->
            new Item(new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB).stacksTo(64)));
    public static final RegistryObject<Item> MITHRIL = ITEMS.register("mithril_ore", ()->
            new Item(new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB).stacksTo(64)));
    public static final RegistryObject<Item> STEEL = ITEMS.register("steel_ore", ()->
            new Item(new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB).stacksTo(64)));
    public static final RegistryObject<Item> DARK_CRYSTAL = ITEMS.register("dark_crystal_ore", ()->
            new Item(new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB).stacksTo(64)));
    //Currency
    ...
    public static final RegistryObject<ArmorItem> YELLOW_JANGOON_ARMOR = ITEMS.register("yellow_jangoon_armor", () ->
            new ArmorItem(WarriorFirstSet.SILVER, EquipmentSlot.CHEST, new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> BROWN_JANGOON_PANTS = ITEMS.register("brown_jangoon_pants", () ->
            new ArmorItem(WarriorFirstSet.SILVER, EquipmentSlot.LEGS, new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> MAROON_JANGOON_SHOES = ITEMS.register("maroon_jangoon_shoes", () ->
            new ArmorItem(WarriorFirstSet.SILVER, EquipmentSlot.FEET, new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> RED_DRAGON_BARBUTE = ITEMS.register("red_dragon_barbute", () ->
            new ArmorItem(WarriorThirdSet.MITHRIL, EquipmentSlot.HEAD, new Item.Properties().tab(MapleSetup.MAPLESTORY_TAB)));
    public static final RegistryObject<ArmorItem> RED_BATTLE_LORD = ITEMS.register("red_battle_lord", () ->
