...
public class MapleUtgardBowmanBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardBowmanMaterial.UTGARD, MobEffects.NIGHT_VISION).build();

    public MapleUtgardBowmanBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
