package com.charlieNgo.maplestorymod.client.init.ArcaneSetItems.Thief;
...
public class MapleArcaneThiefBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneThiefMaterial.ARCANE, MobEffects.MOVEMENT_SPEED).build();

    public MapleArcaneThiefBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
