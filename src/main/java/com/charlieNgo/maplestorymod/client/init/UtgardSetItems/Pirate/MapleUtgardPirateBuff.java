package com.charlieNgo.maplestorymod.client.init.UtgardSetItems.Pirate;
...
public class MapleUtgardPirateBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardPirateMaterial.UTGARD, MobEffects.DAMAGE_BOOST).build();

    public MapleUtgardPirateBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
