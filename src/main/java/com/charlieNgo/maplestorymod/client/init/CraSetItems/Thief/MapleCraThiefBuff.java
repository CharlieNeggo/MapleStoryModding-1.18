...
public class MapleCraThiefBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraThiefMaterial.CRA, MobEffects.DAMAGE_BOOST).build();

    public MapleCraThiefBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
