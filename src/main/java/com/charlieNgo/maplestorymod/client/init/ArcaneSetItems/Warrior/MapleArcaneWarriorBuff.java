...
public class MapleArcaneWarriorBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneWarriorMaterial.ARCANE, MobEffects.DAMAGE_BOOST).build();

    public MapleArcaneWarriorBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
