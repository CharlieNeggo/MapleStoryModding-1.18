...
public class MapleUtgardMagicianBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleUtgardMagicianMaterial.UTGARD, MobEffects.LUCK).build();

    public MapleUtgardMagicianBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
