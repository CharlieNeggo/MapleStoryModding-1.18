package com.charlieNgo.maplestorymod.client.init.AbsolabSetItems.Thief;
...
public class AbsolabThiefBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabThiefMaterial.ABSOLAB, MobEffects.DAMAGE_BOOST).build());

    public AbsolabThiefBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
