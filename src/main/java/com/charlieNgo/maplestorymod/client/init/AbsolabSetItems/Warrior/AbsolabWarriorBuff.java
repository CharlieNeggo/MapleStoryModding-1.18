...
public class AbsolabWarriorBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabWarriorMaterial.ABSOLAB, MobEffects.DAMAGE_RESISTANCE).build());

    public AbsolabWarriorBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
