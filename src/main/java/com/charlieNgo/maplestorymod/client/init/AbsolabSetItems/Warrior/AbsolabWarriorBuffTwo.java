package com.charlieNgo.maplestorymod.client.init.AbsolabSetItems.Warrior;
...
public class AbsolabWarriorBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>()
                    .put(MapleAbsolabWarriorMaterial.ABSOLAB, MobEffects.DAMAGE_BOOST).build());

    public AbsolabWarriorBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
