...
public class MapleArcaneThiefBuff extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleArcaneThiefMaterial.ARCANE, MobEffects.DAMAGE_BOOST).build();

    public MapleArcaneThiefBuff(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
