...
public class MapleCraPirateBuffTwo extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(MapleCraPirateMaterial.CRA, MobEffects.JUMP).build();

    public MapleCraPirateBuffTwo(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
