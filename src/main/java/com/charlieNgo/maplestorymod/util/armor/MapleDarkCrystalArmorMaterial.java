package com.charlieNgo.maplestorymod.util.armor;
...
public class MapleDarkCrystalArmorMaterial implements ArmorMaterial {
    ...
    public MapleDarkCrystalArmorMaterial(int enchantability, int[] durability, int[] damageReduction,
