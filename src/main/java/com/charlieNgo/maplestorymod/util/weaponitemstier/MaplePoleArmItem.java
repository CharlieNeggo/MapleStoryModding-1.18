...
import com.charlieNgo.maplestorymod.util.MapleToolActions;
...
public class MaplePoleArmItem extends DiggerItem {
    ...
    public MaplePoleArmItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Item.Properties pProperties) {
    ...
    public boolean canPerformAction(ItemStack stack, MapleToolActions toolAction) {
        return MapleToolActions.DEFAULT_POLE_ARM_ACTIONS.contains(toolAction);
    }
}
